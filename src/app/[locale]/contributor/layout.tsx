                ...
                <div className="max-w-screen-2xl mx-auto flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <span className="text-[10px] uppercase tracking-[0.2em] font-medium text-[var(--paper-plane-grey)] border-l border-[var(--ink-line)] pl-4">
                            Firm / Contributor Portal
                        </span>
                    </div>
                    <nav className="flex items-center gap-6">
                        <Link className="text-xs font-semibold text-white/80 hover:text-[var(--mustard-gold)] transition-colors uppercase tracking-wider" href="/contributor">
                            My Works
                        </Link>
                        <Link className="text-xs font-semibold text-white/80 hover:text-[var(--mustard-gold)] transition-colors uppercase tracking-wider" href="/contributor">
                            Analytics
                        </Link>
                        <div className="w-8 h-8 border border-[var(--paper-plane-grey)] flex items-center justify-center rounded-full ml-4">
                            <span className="material-symbols-outlined text-sm text-[var(--paper-plane-grey)]">domain</span>
                        </div>
                    </nav>
                </div>
            </header>
