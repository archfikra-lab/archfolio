...
export default function SubmitProjectPage() {
    ...
    const handleAnalyzeDocument = (e: React.MouseEvent) => {
        e.preventDefault();
        ...
        setTimeout(() => {
            setFormData(prev => ({
                ...prev,
                title: prev.title || 'King Hussein Business Park Expansion',
                shortDescription: prev.shortDescription || 'A modern business hub expansion emphasizing sustainability and seamless grid integration.',
                location: prev.location || 'Amman, Jordan',

                contextual: 'Located in a semi-arid climate zone. Optimal sun orientation utilized for south-facing solar gain reduction. Complies with Amman municipality height limits (max 8 floors).',
                sustainability: 'Targeting LEED Gold. Features 30% reduction in carbon footprint via low-carbon concrete. Full lifecycle analysis conducted on facade materials.',
                regulatory: 'Meets Jordan National Building Codes for fire safety. Universal design implemented across all public transition zones.',
                budget: 'Estimated $45M construction cost. Projected 24-month timeline.',

                formal: 'Dual interconnected massing strategy to break down scale. Prominent central circulation spine acting as a thermal chimney.',
                materiality: 'High-performance double-skin glass facade (U-value 1.1). Local basalt stone cladding on podium (R-value 3.5).',
                programming: '70% Class-A Office space, 20% Retail and amenities, 10% Public plazas.',
                acoustics: 'Acoustic louvers installed near mechanical zones. Daylight factor > 2% in 80% of occupied spaces.',

                foundation: 'Deep pile foundation (15m) due to variable clay soil bearing capacity.',
                lateral: 'Reinforced concrete shear core coupled with perimeter moment frame.',
                grid: '9m x 9m clear span grid for maximum office layout flexibility.',
                material: 'Concrete grade C40/50. Rebar yield strength fy=420 MPa.',

                hvac: 'Water-cooled VRF system with dedicated outdoor air systems (DOAS).',
                ventilation: 'Demand-controlled mechanical ventilation with rotary heat exchangers (75% recovery efficiency).',
                water: 'Greywater recycling system for irrigation and toilet flushing. Low-flow fixtures reducing usage by 40%.',

                power: 'Power density limited to 8 W/m2 for lighting. High-efficiency transformers.',
                renewable: 'Rooftop 200 kWp Solar PV array tied to 50kWh battery storage unit.',
                automation: 'Fully integrated KNX Building Management System for lighting and HVAC zone control.'
            }));
